...
export declare const CS_MIN_WEAR = 0.000001;
export declare const CS_MAX_WEAR = 0.999999;
export declare const CS_MIN_FACTORY_NEW_WEAR = 0.000001;
...
export declare const CS_MAX_BATTLE_SCARRED_WEAR = 0.999999;
...
export declare function CS_hasWear(csItem: CS_Item): boolean;
...
export declare function CS_resolveItemImage(baseUrl: string, csItem: CS_Item | number, wear?: number): string;
